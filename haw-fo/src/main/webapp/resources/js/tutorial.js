...
chatComment[2] = "<p>이번엔 도시를 선택 할 차례입니다.<br>" +
		"도시를 선택하면 각 도시에 있는 의뢰들을 확인할 수 있습니다.<br><br>" +
...
chatComment[4] = "<p>서귀포시에는 3개의 의뢰가 존재합니다.<br><br>" +
		"현재는 QUEST1과 QUEST2만 선택 가능합니다.<br>" +
		"두개의 의뢰를 해결하면 QUEST3이 활성화 될 것 입니다.<br>" +
		"QUEST 아이콘을 통해 문제의 유형을 알 수 있습니다.<br><br>" +
		"QUEST1을 클릭 해보세요!</p>";
chatComment[5] = "<p>QUEST1의 아이콘은 '문답' 혹은 '미니게임' 형태의 문제입니다.<br><br>" +
		"계속 진행하시려면 ACCEPT를 클릭 해보세요!</p>";
chatComment[6] = "<p>문제를 읽고 답을 입력란에 입력해주시고, 우측 보내기 버튼을 클릭해 주세요!</p>";	
chatComment[7] = "<p>첫번째 의뢰를 해결하셨어요!<br><br>" +
...
chatComment[12] = "<p>이번에는 파일을 다운로드해서 FLAG를 찾는 유형의 문제입니다.<br><br>" +
		"계속 진행하시려면 ACCEPT를 클릭 해보세요!</p>";
chatComment[13] = "<p>간단한 의뢰가 들어와있네요!<br><br>" +
		"파일을 다운로드 받고 안쪽에 있는 FLAG을 찾아보세요.<br><br>" +
		"메시지는 일반적으로 FLAG를 뜻합니다.</p>";
chatComment[14] = "<p>좌측하단 AUTH 버튼을 눌러 최종 FLAG를 입력해보세요!";
chatComment[15] = "<p>축하드립니다~! 두번째 의뢰를 완수하였습니다.<br><br>" +
		"보상을 획득합니다.<br><br>" +
		"이제 튜토리얼은 마지막 한단계 남았습니다!</p>";
chatComment[16] = "<p>잡겨있던 QUEST3이 열렸습니다!<br><br>" +
	"QUEST3을 클릭해보세요.</p>";
chatComment[17] = "<p>QUEST3의 아이콘은 서버에 접속하여 푸는 문제입니다!<br><br>" +
	"계속 진행하시려면 ACCEPT를 클릭 해보세요!</p>";
chatComment[18] = "<p>FLAG를 지금까지와 마찬가지로 아래 입력란에 입력 해주세요.</p>";
...
$(function(){
	...
	//튜토리얼 제주도
		...
		$("#1quest").click(function(){
			$("#questInfoDetailPop").attr("class", "infoPopUp01");
	...
	//레벨3
		...
		$("#1quest, #2quest").parent().children("dd").addClass("clear");
		...
		$("#3quest").click(function(){
			$(".questInfo ul li:eq(2)").text("1 Question");
			$("#questInfoDetailPop").attr("class", "infoPopUp03");  
			$(".questInfoPopUpWrap").show();
